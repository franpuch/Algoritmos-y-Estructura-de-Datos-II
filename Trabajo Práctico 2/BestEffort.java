...
public class BestEffort {
    ...
    public BestEffort (int cantCiudades, Traslado[] traslados){
        ...
        for(int i = 0; i < arrayCopiaTraslados.length; i++) {                           // Itera |Traslados| veces.
    ...
    public void registrarTraslados(Traslado[] traslados){
        ...
        Traslado[] arrayCopiaTraslados = new Traslado[traslados.length];            // O(1)
        for(int i = 0; i < arrayCopiaTraslados.length; i++) {                       // Itera|T| veces.
            arrayCopiaTraslados[i] = new Traslado(traslados[i]);                    // O(1)
        }   
        // Este ciclo pertenece a O(|T|).

        for(Traslado traslado : arrayCopiaTraslados) {                              // Itera |T| veces.
