...
public class HeapsTraslado {
    ...
    public HeapsTraslado() {
        ...
        // CrEación del comparador por ganancia.
        ...
        // Creación del comparador por tiempo.
    ...
    public HeapsTraslado(Traslado[] array) {
        ...
        // Agrego los elementos al array de 'heapPorGanancia' y 'heapPorTiempo' para después ordenarlo.
    ...
    // Demostración informal: como vamos de abajo a arriba, la sumatoria de 'logs (i)' es pequeño y solo hay pocos que sea grandes.
    ...
    // 'prioridadMayorQuePadrePorGanancia' es O(1).
    ...
    // 'subirElementoTiempo' es O(log (n)).
    ...
    // 'prioridadMayorQuePadrePorTiempo' es O(1).
    ...
    // 'eliminarGanancia' es O(log (n)).
    private Traslado eliminarGanancia(int index) {        
        Traslado returnValue = this.heapPorGanancia.get(index);                                    // O(1) 
        ...
        // Esto es O(max de todos ifs). En este caso, es O(log (n))
        return returnValue;                                                                         // O(1)
    }

    // 'eliminarTiempo' es O(log (n)).
    ...
    // 'bajarGanancia' es O(log (n)).
    private void bajarGanancia(int index) {
        while (!this.esHoja(index) && this.prioridadDeAlgunHijoEsMayorGanancia(index)) {            // Se ejecuta 'log (n)' veces.
    ...
    // 'prioridadDeAlgunHijoEsMayorGanancia' es O(1).
    ...
    // 'prioridadDeAlgunHijoEsMayorTiempo' es O(1).
    ...
    // 'calcularPosicionHijoIzquierdo' es O(1).
